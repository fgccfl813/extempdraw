    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="draw.php" method="get">
                ...
                <select name="r" id="roundSelect" class="form-select mb-3" aria-label="Round selector">
                    <?php include TPL . '/active_rounds.html.php'; ?>
                </select>
                <div class="mb-3">
                    <label for="drawCode" class="form-label">Speaker Code and Initials</label>
                    <input type="text" class="form-control" name="dc" id="drawCode" placeholder="X000AB" aria-describedby="drawCodeGuidance">
